                                                    ...
                                                    <div class="module-container   only-mobile   align-left ModuleParagraph
                                                        ...
                                                        <div class="  module ModuleParagraph " datamodule-id="1436" style="display:block;max-width:952px;">
                                                            <div class="uc-content ">
                                                                ...
                                                                <p style="color:rgb(32, 37, 49);"><br><span class="font-13em"><span style="font-family:Roboto;"><strong>EMAIL</strong></span></span><br><span class="font-13em"><span style="font-family:Roboto;">For all customer queries, please email us at <span style="color:rgb(166, 29, 103);">support@alivecasino.com</span> and quote your name and account number.</span></span></p>
                                                                <p style="color:rgb(32, 37, 49);"><br><span class="font-13em"><span style="font-family:Roboto;">For all other questions or offers, please email us on <span style="color:rgb(166, 29, 103);">info@alivecasino.com</span><span style="color:rgb(64, 64, 64);">.</span><span style="color:rgb(166, 29, 103);"> </span><span style="color:rgb(0, 0, 0);">Your</span> request</span></span></p>
                                                                <p style="color:rgb(32, 37, 49);"><br><span class="font-13em"><span style="font-family:Roboto;">Please use <span style="color:rgb(166, 29, 103);">docs@alivecasino.com</span> when sending us your verification documents.</span></span></p>
                                                                ...
                                                                <div class="accordion-container">
                                                                        ...
                                                                        <div class="accordion-item-content">
                                                                            ...
                                                                            <div class="accordion-item-description">
                                                                                <div class="description-container">
                                                                                    <p>Registration on Alivecasino website is a condition for using all the products available on the website. Registration entitles you to open a alivecasino.com account free-of-charge and without obligations. Use the account to manage your bets and personal data. You can make bets with real money after you replenish your account.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="accordion-item">
                                                                        <div class="accordion-item-content">
                                                                            ...
                                                                            <div class="accordion-item-description">
                                                                                <div class="description-container">
                                                                                    <p>The accuracy of your data is a condition of using our products. Management of your money in your Alivecasino account is implemented in a similar way to a bank account. We need to know your first name and last name, as well as your current residential address. By entering your date of birth, you verify that you are of legal age to use the services of Alivecasino. It is important for us to have your email address so that if you forget your password or want us to send you notifications, we will be able to get in touch with you by email.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="clearfix"></div>
                                                                        ...
                                                                        <div class="accordion-item-content">
                                                                            <div class="accordion-item-title">
                                                                                <div class="accordion-item-title-wrapper">
                                                                                    ...
                                                                                    <div class="title-container">
                                                                                        Do I undertake any obligations by registering on the Alivecasino website?
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="accordion-item-description">
                                                                ...
                                                                <div class="accordion-container">
                                                                            ...
                                                                            <div class="accordion-item-description">
                                                                                <div class="description-container">
                                                                                    ...
                                                                                    <ul>
                                                                                        ...
                                                                                        <li>If the match ends 0-3, then adding the handicap will produce a score of 2-3 and the bet will lose.</li>
                                                                                        <li>If the match ends 0-2, then adding the handicap will produce a score of 2-2 and the bet will result in a push (stakes returned).</li>
                                                                                        <li>If the handicap is “negative”, you need to subtract rather than add.</li>
                                                                                    </ul>
                                                                                    <p>&nbsp;</p>
                                                                                    <p><strong>Here are a few other examples of a handicap:</strong></p>
                                                                                    <ul>
                                                                                        <li>Bet W1 Handicap (-1) can win only when the home team wins the match by two goals.</li>
                                                                                        <li>Bet W2 Handicap (1) can win only when the away team does not lose the match (draw or victory of the away team).</li>
                                                                                        <li>Bet X Handicap (1) can win only when the home team wins the match by one goal (or when the away team loses by one goal).</li>
                                                                                        <li>Bet X Handicap (-1) can win only when the home team loses the match by one goal (if the away team wins by one goal).</li>
                                                                                        <li>Bet W1 Handicap (-2) can win only when the home team wins the match by three goals. Bet W2 Handicap (2) can win only in the following result of the match:<br>A draw<br>The victory of the home team by one goal</li>
                                                                                    </ul>
                                                                                    <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Any victory by the away team.</p>
                                                                                    <ul>
                                                                                        <li>Bet X Handicap (2) can win only when the home team wins by two goals.</li>
                                                                                        <li>Bet X Handicap (-2) can win only when the home team loses by two goals (or the away team wins by two goals).</li>
                                                                                    </ul>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="accordion-item">
                                                                        <div class="accordion-item-content">
                                                                            ...
                                                                            <div class="accordion-item-description">
                                                                                <div class="description-container">
                                                                                    <p>Alivecasino reserves the right to set various betting limits for all events, markets and selections. You will be informed of any limits when you place your bet.</p>
                                                                    ...
                                                                    <div class="accordion-item">
                                                                        <div class="accordion-item-content">
                                                                            ...
                                                                            <div class="accordion-item-description">
                                                                                <div class="description-container">
                                                                                    <p>All football bets are settled only for the 90-minute result (full-time), excluding extra time and penalty shoot-outs, unless otherwise stipulated by Alivecasino.com. According to Alivecasino’s rules, full-time includes any stoppage time during the 90 minutes.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="clearfix"></div>
                                                                ...
                                                                <div class="accordion-container">
                                                                    ...
                                                                    <div class="accordion-item">
                                                                        <div class="accordion-item-content">
                                                                            ...
                                                                            <div class="accordion-item-description">
                                                                                <div class="description-container">
                                                                                    <p>Alivecasino reserves the right to reduce the limit of all or some players. Alivecasino is not obliged to provide an explanation concerning these decisions and reserves the right to block some players from using its services.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="clearfix"></div>
                                                                ...
                                                                <div class="accordion-container">
                                                                    <div class="accordion-item">
                                                                        <div class="accordion-item-content">
                                                                            ...
                                                                            <div class="accordion-item-description">
                                                                                <div class="description-container">
                                                                                    <p>Playing in the Alivecasino Casino requires a Alivecasino Account. If you do not already have one, just click on the “Register” button on the Casino page and follow the simple registration process.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="clearfix"></div>
                                                                        ...
                                                                        <div class="accordion-item-content">
                                                                            <div class="accordion-item-title">
                                                                                <div class="accordion-item-title-wrapper">
                                                                                    ...
                                                                                    <div class="title-container">
                                                                                        What kind of games can I play online at the Alivecasino Casino?
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="accordion-item-description">
                                                                                <div class="description-container">
                                                                                    <p>Alivecasino offers a wide selection of games to our players. You can find many different 3D games, Table games, a huge variety of Slot games, and even Live games including Blackjack, Roulette, Baccarat and Bet on Poker.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="clearfix"></div>
