<div class="header-rows" style="  margin-bottom:0vh;  background:rgb(29, 24, 78);">
    <div class="header-row-wrapper sb-account-row">
        <div class="uc-row-wrapper ">
            <div class="uc-row  vbetheader header-row" data-id="12902" style="margin-bottom:0vh;background:rgba(89, 72, 147, 0); ">
                <div class="row-container">
                    <div class="row headerRow">
                        <div class="column col-xs-1 " datacolumn-id="21535" style="  padding:5px 0px;background: transparent;">
                            <div class="column-container">
                                <div class="module-container only-mobile align-right ModuleLogo
                         first last" style=" padding-right:0px;padding-left:20px;">
                                    <div class="  vbetlogo  module ModuleLogo " datamodule-id="59217" style="display:block;max-width: 100%;">
                        ...
                        <div class="column col-xs-2 " datacolumn-id="21536" style="  padding:5px 0px;      background: transparent; ">
                            <div class="column-container ">
                                <div class="module-container only-mobile   align-left ModuleImage
                         first last                         " style=" padding-right:40px;padding-left:30px;;  ">
                                    <div class="  module ModuleImage " datamodule-id="59218" style="display:block;max-width: 100%;">
                                        <div class="animated animated-59218 " data-loading-animation="" data-animated-id="59218">
                                            <div class=" ">
                                                <div>
                                                    <div class="">
                                                        <img class="image lazy initial loaded" data-src="https://static.betconstruct.me/fs/userFiles/vbetcom-updated/images/59218-badge-sp-15797686148272.png" data-webp="0" src="https://static.betconstruct.me/fs/userFiles/vbetcom-updated/images/59218-badge-sp-15797686148272.png" data-was-processed="true">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="column col-xs-5 " datacolumn-id="21537" style="  padding:5px 0px;     ">
                            <div class="column-container ">
                                <div class="module-container only-mobile align-right ModuleNavigation
                         first last                         " style=" padding-right:80px;padding-left:30px;;  ">
                                    <div class="  module ModuleNavigation " datamodule-id="59219" style="width: auto;">
                                        <input type="hidden" class="standard-navigation">
                                        <style>
                                            #navigation-59219>.standard-view>.navigation>.page>.page-children {
                                                background: rgb(31, 23, 71);
                                            }

                                            #navigation-59219>.standard-view>.navigation>.page>.page-children>.page>ul {
                                                background: rgb(31, 23, 71);
                                            }
                                            ...
                                            #navigation-59219 .navigation>li.has-childes.page>ul a {
                                                padding: 0 15px;
                                            }

                                            #navigation-59219>div>ul li:hover>ul {
                                                display: block;
                                            }


                                            #navigation-59219 .page a {
                                            ...
                                            #navigation-59219>div>ul>li.page:not(:last-child) {
                                                margin-right: 11px;
                                            }

                                            #navigation-59219>div>ul>li:first-child:nth-last-child(1) {}

                                            #navigation-59219 li.page>a:hover {
                                                color: rgb(254, 203, 90) !important;
                                            }

                                            #navigation-59219 li.page.active>a {
                                                color: rgb(254, 203, 90);
                                            }

                                            #navigation-59219 li.page.active>a:hover {
                                                color: rgb(254, 203, 90) !important;
                                            }

                                            #navigation-59219 li.page>ul.page-children li.page a {
                                                color: rgb(255, 255, 255);
                                            }

                                            #navigation-59219 li.page>ul.page-children>li.page a:hover,
                                            #navigation-59219 li.page>ul.page-children>li.page>ul.page-children>li.page a:hover {
                                                color: #959595 !important;
                                            }

                                            #navigation-59219 li.page>ul.page-children>li.page.active>a,
                                            #navigation-59219 li.page>ul.page-children>li.page>ul.page-children>li.page.active>a {
                                                color: #353535;
                                            }

                                            #navigation-59219 li.page>ul.page-children>li.page.active>a:hover,
                                            #navigation-59219 li.page>ul.page-children>li.page>ul.page-children>li.page.active>a:hover {
                                                color: #959595 !important;
                                            }

                                            #navigation-59219 li.page>ul.page-children:before,
                                            #navigation-59219 li.page>ul.page-children>li.has-childes>.page-children.pagesArrows>li:first-child:before {
                                                color: rgb(31, 23, 71);
                                            }
                                            ...
                                            #navigation-59219 li.page ul.page-children .page {
                                                padding-top: 11px;
                                                padding-bottom: 11px;
                                            }

                                            #navigation-59219 li.page ul.page-children .page:last-child {
                                                padding-bottom: 11px;
                                            }

                                            #navigation-59219 li.has-childes.page>a>.uci-dropdown-arrow-down {
                                                font-size: 7.5px;
                                            }

                                            #navigation-59219 li.has-childes.page>.page-children.pagesArrows>.has-childes>a>.uci-dropdown-arrow-down {
                                                font-size: 7px;
                                            }

                                            #navigation-59219 li.has-childes.page>.page-children li>a,
                                            #navigation-59219 li.has-childes.page>.page-children li {
                                                text-align: center;
                                            }
                                        </style>
                                        <div id="navigation-59219" data-nav-sub-page-scollapsible="0" class="navigation-inner
                
        horizontal standard">
                                            <div class="off-canvas-button icon" data-selector="off-canvas-59219" style="width:25px;height:25px;">
                        ...
                        <div class="column col-xs-1 " datacolumn-id="21538" style="  padding:5px 0px;     ">
                            <div class="column-container ">
                            </div>
                        </div>
                        <div class="column col-xs-2 " datacolumn-id="21539" style="  padding:5px 0px;     ">
                            <div class="column-container ">
                                <div class="module-container only-mobile align-right ModuleSbAccount
                         first last                         " style=" padding-right:0px;padding-left:0px;;  ">
                                    <div class="  module ModuleSbAccount " datamodule-id="101862" style="display:block;max-width: 100%;">
                                                ...
                                                <div id="ember49" class="ember-view">
                                                    <div id="ember50" class="loginRegisterButtons sb-login-register-buttons clearfix ember-view">
                                                        <style>
                                                            ...
                                                            #ember49 .sb-login-register-buttons .signup-btn.link:hover {
                                                                color: #383838;
                                                            }

                                                            #ember49 .sb-login-register-buttons .signin-btn.link {
                                                                color: rgb(255, 255, 255);
                                                                font-size: 14px;
                                                                letter-spacing: 0px;
                                                                font-family: Roboto;
                                                            ...
                                                            #ember49 .sb-login-register-buttons .signin-btn.link:hover {
                                                                color: rgb(246, 219, 124);
                                                            }

                                                            #ember49 .sb-login-register-buttons.vertical a {
                                                                margin: 0 0 8px 0;
                                                            }

                                                            #ember49 .sb-login-register-buttons:not(.vertical) a {
                                                                margin: 0 8px 0 0;
                                                            }

                                                            #ember49 .sb-login-register-buttons .icon-block.signup-btn {
                                                                width: 36px;
                                                                height: 36px;
                                                                color: #303838;
                                                                fill: #303838;
                                                            ...
                                                            #ember49 .sb-login-register-buttons .icon-block.signup-btn:hover {
                                                                color: #303838;
                                                                fill: #303838;
                                                            }

                                                            #ember49 .sb-login-register-buttons .icon-block.signin-btn {
                                                                width: 36px;
                                                                height: 36px;
                                                                color: #303838;
                                                                fill: #303838;
                                                            ...
                                                            #ember49 .sb-login-register-buttons .icon-block.signin-btn:hover {
                                                                color: #303838;
                                                                fill: #303838;
                                                            }


                                                            [dir="rtl"] #ember50.sb-login-register-buttons:not(.vertical) a {
                                                                margin: 0 0 0 8px;
                                                            }
                                                        </style>

                                                        <div id="ember52" class="ember-view"> <a class="btn signup-btn sbRegisterBtn buttons1559303638104" data-ember-action="" data-ember-action-53="53">
                                                                <span class="btn-text">REGISTRARSE</span>
                                                            </a>
                                                        </div>
                                                        <div id="ember55" class="ember-view"> <a class="link signin-btn sbLoginBtn" data-ember-action="" data-ember-action-56="56">
                        ...
                        <div class="column col-xs-1 " datacolumn-id="21540" style="  padding:5px 0px;     ">
                            <div class="column-container vertical-center">
                                <div class="module-container only-mobile   align-center ModuleLanguageSwitcher
                         first last                         ">
                                    <div class="  module ModuleLanguageSwitcher " datamodule-id="59223">
                                        <style>
                                            .ModuleLanguageSwitcher[datamodule-id="59223"] .uci-dropdown-arrow-down.lng-ic-down {
                                                font-size: 11px;
                                            }

                                            .ModuleLanguageSwitcher[datamodule-id="59223"] .flag {
                                                height: 16px;
                                                width: 24px;
                                            }

                                            .ModuleLanguageSwitcher[datamodule-id="59223"] .uci-dropdown-arrow-down,
                                            .custom-arrow-dropdown {
                                                margin-left: 0px;
                                            }

                                            html[dir=rtl] .ModuleLanguageSwitcher[datamodule-id="59223"] .uci-dropdown-arrow-down,
                                            html[dir=rtl] .ModuleLanguageSwitcher[datamodule-id="59223"] .custom-arrow-dropdown {
                                                margin-right: 0px;
                                                margin-left: 0;
                                            }
                                        </style>
                                        <div class="languages open-on-hover top">
                                            ...
                                            <ul class="native-scroll-box">
                                                <li>
                                                    <a data-href="/english/index.php" class="" href="/english/index.php">
                                                ...
                                                <!-- <li>
                                                    <a onclick="changeLanguage(this,'pt-br');" data-href="https://www.vbet.com/pt-br/privacy-policy" class="" href="https://www.vbet.com/pt-br/privacy-policy">
    ...
    <div class="header-row-wrapper">
        <div class="uc-row-wrapper ">
            <div class="uc-row                             header-row  
                                                        ...
                                                        " data-id="12904" style="   margin-bottom:0vh;  ">
                <div class="row-container ">
                    <div class="row headerRow ">
                        <div class="column col-xs-12 " datacolumn-id="21544" style="  padding:0px 0px;     ">
                            <div class="column-container ">
                                <div class="module-container  align-center ModuleCustomHtml
                         first last                         ">
                                    <div class="  module ModuleCustomHtml " datamodule-id="59228">
                                        <div class="custom-html-container">
                                            <style>
                                                ...
                                                .header-and-main-rows.higher-zindex-than-footer>.header-rows,
                                                .header-and-main-rows.higher-zindex-than-footer {
                                                ...
                                                .module-container .slider-container>.slider-container>.gallery-image a.btn:hover,
                                                .row-on-module .module-container .dark-button-hover .btn:hover {
                                                    box-shadow: 0px 4px 4px -1px rgba(32, 205, 142, .6);
                                                }
