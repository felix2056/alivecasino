                                        ...
                                        <div class="  module ModuleLanguageSwitcher " datamodule-id="50382">
                                            ...
                                            <div class="languages open-on-hover top">
                                                ...
                                                <ul class="native-scroll-box">
                                                    <li>
                                                        <a onclick="changeLanguage(this,'tr');" data-href="https://www.vbet.com/tr/casino-yardim" class="" href="https://www.vbet.com/tr/casino-yardim">
                                                    ...
                                                    <li>
                                                        <a onclick="changeLanguage(this,'ka');" data-href="https://www.vbet.com/ka/casino-help" class="" href="https://www.vbet.com/ka/casino-help">
                                                    ...
                                                    <li>
                                                        <a onclick="changeLanguage(this,'ru');" data-href="https://www.vbet.com/ru/kazino-pomosh" class="" href="https://www.vbet.com/ru/kazino-pomosh">
                                                    ...
                                                    <li>
                                                        <a onclick="changeLanguage(this,'uk');" data-href="https://www.vbet.com/uk/kazino-pomosh" class="" href="https://www.vbet.com/uk/kazino-pomosh">
                                                    ...
                                                    <li>
                                                        <a onclick="changeLanguage(this,'es');" data-href="https://www.vbet.com/es/casino-help" class="" href="https://www.vbet.com/es/casino-help">
                                                    ...
                                                    <li>
                                                        <a onclick="changeLanguage(this,'pt-br');" data-href="https://www.vbet.com/pt-br/casino-help" class="" href="https://www.vbet.com/pt-br/casino-help">
                                                    ...
                                                    <li>
                                                        <a onclick="changeLanguage(this,'fra');" data-href="https://www.vbet.com/fra/aide-casino" class="" href="https://www.vbet.com/fra/aide-casino">
                                                    ...
                                                    <li>
                                                        <a onclick="changeLanguage(this,'fa');" data-href="https://www.vbet.com/fa/casino-help" class="" href="https://www.vbet.com/fa/casino-help">
    ...
    <div class="main-rows">
        <div class="uc-row-wrapper ">
            <div class="uc-row    last                           
                                                        ...
                                                        " data-id="398" style="   margin-bottom:4.9554013875124vh;  ">
                <div class="row-container  container ">
                    <div class="row mainRow" style="">
                        <div class="column col-sm-6 uc-animation affix active" datacolumn-id="620" data-effect="affix" style="  padding:0vh 0vh;     ">
                         ...
                         first                          " style="  padding-bottom:1.1350737797957vh; ">
                                        <div class="  module ModuleSpace " datamodule-id="1613">
                                            <div class="space-container">
                                                <div class="space-inner" style="height: 10px;">
                                                </div>
                                            </div>
                                            <style>
                                                .ModuleSpace[datamodule-id="1613"] .space-container {
                                                    border-radius: 0 0 0 0;
                                                    background: transparent;
                                                }

                                                .ModuleSpace[datamodule-id="1613"]:hover .space-container {
                                                    border-radius: 0 0 0 0;
                                                }
                                            </style>
                                            <style>
                                                .ModuleSpace[datamodule-id="1613"] .uc-row .column:first-child {
                                                    border-bottom-left-radius: 0;
                                                    border-top-left-radius: 0;
                                                }

                                                .ModuleSpace[datamodule-id="1613"] .uc-row .column:last-child {
                                                    border-bottom-right-radius: 0;
                                                    border-top-right-radius: 0;
                                                }
                                            </style>
                                    ...
                                    <div class="module-container  align-left ModuleTitle
                                        ...
                                        <div class="  casinottl  module ModuleTitle " datamodule-id="1776">
                                            <div class="uc-content">
                                                <h1 style="color:rgb(255, 255, 255);"><span style="font-family:'Arm Hmks Bebas Neue Regular Custom';"><span style="color:rgb(64, 64, 64);">Casino</span></span></h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="module-container   only-mobile   align-center ModuleSpace
                                                 " style="  padding-bottom:0vh; ">
                                        <div class="  module ModuleSpace " datamodule-id="19697">
                                            <div class="space-container">
                                                <div class="space-inner" style="height: 10px;">
                                                </div>
                                            </div>
                                            <style>
                                                .ModuleSpace[datamodule-id="19697"] .space-container {
                                                    border-radius: 0 0 0 0;
                                                    background: transparent;
                                                }

                                                .ModuleSpace[datamodule-id="19697"]:hover .space-container {
                                                    border-radius: 0 0 0 0;
                                                }
                                            </style>
                                            <style>
                                                .ModuleSpace[datamodule-id="19697"] .uc-row .column:first-child {
                                                    border-bottom-left-radius: 0;
                                                    border-top-left-radius: 0;
                                                }

                                                .ModuleSpace[datamodule-id="19697"] .uc-row .column:last-child {
                                                    border-bottom-right-radius: 0;
                                                    border-top-right-radius: 0;
                                                }
                                            </style>
                                    ...
                                    <div class="module-container  align-left ModuleParagraph
                                        ...
                                        <div class="  module ModuleParagraph " datamodule-id="1777" style="display:block;max-width:952px;">
                                            <div class="uc-content ">
                                                <p><strong>House always wins they say! But what’s house and what is win? &nbsp;Be aware all the details, respect the rules of house and let the fortune be your best friend!</strong></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="module-container  align-left ModuleDivider
                                                 " style=" padding-right:40px;padding-left:40px;;   padding-bottom:1.982160555005vh; ">
                                        <div class="  module ModuleDivider " datamodule-id="1778" style="display:block;max-width:60px;">
                          ...
                          last                         " style=" padding-right:40px;padding-left:40px;;  ">
                                        <div class="  module ModuleButton " datamodule-id="1779">
                                            <div class="button">
                        ...
                        <div class="column col-sm-6 " datacolumn-id="621" style="  padding:0vh 0vh;     ">
                            <div class="column-container vertical-top" style=" margin-top:1.982160555005vh; ">
                                <div class="module-container   only-mobile   align-center ModuleSpace
                         first                          " style="  padding-bottom:1.1350737797957vh; ">
                                    <div class="  module ModuleSpace " datamodule-id="19593">
                                        <div class="space-container">
                                            <div class="space-inner" style="height: 10px;">
                                            </div>
                                        </div>
                                        <style>
                                            .ModuleSpace[datamodule-id="19593"] .space-container {
                                                border-radius: 0 0 0 0;
                                                background: transparent;
                                            }

                                            .ModuleSpace[datamodule-id="19593"]:hover .space-container {
                                                border-radius: 0 0 0 0;
                                            }
                                        </style>
                                        <style>
                                            .ModuleSpace[datamodule-id="19593"] .uc-row .column:first-child {
                                                border-bottom-left-radius: 0;
                                                border-top-left-radius: 0;
                                            }

                                            .ModuleSpace[datamodule-id="19593"] .uc-row .column:last-child {
                                                border-bottom-right-radius: 0;
                                                border-top-right-radius: 0;
                                            }
                                        </style>
                                ...
                                <div class="module-container   only-mobile   align-left ModuleParagraph
                                    ...
                                    <div class="  module ModuleParagraph " datamodule-id="1780" style="display:block;max-width:1702px;">
                                        <div class="uc-content ">
                                            <h5 style="color:rgb(53, 53, 53);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);"><strong>How can I create a Casino account?</strong></span></span></h5>
                                            <p style="color:rgb(53, 53, 53);">&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">Playing in the Vbet Casino requires a Vbet Account. If you do not already have one, just click on the “Register” button on the Casino page and follow the simple registration process.</span></span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="module-container  align-left ModuleDivider
                                                 " style=" padding-right:40px;padding-left:30px;;   padding-bottom:1.982160555005vh; ">
                                    <div class="  module ModuleDivider " datamodule-id="1781" style="display:block;max-width:60px;">
                                        <div class="divider-container">
                                ...
                                <div class="module-container   only-mobile   align-left ModuleParagraph
                                                 " style=" padding-right:30px;padding-left:30px;;   padding-bottom:1.982160555005vh; ">
                                    <div class="  module ModuleParagraph " datamodule-id="1782" style="display:block;max-width:1702px;">
                                        <div class="uc-content ">
                                            <h5 style="color:rgb(53, 53, 53);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);"><strong>What should I do if I have forgotten my username/password?</strong></span></span></h5>
                                            <p style="color:rgb(53, 53, 53);">&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">If you’ve forgotten your password, first try to restore it through the site using the “Forgot password?” option.&nbsp;</span></span></p>
                                            <p style="color:rgba(49, 49, 49, 0.7);">&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">Password recovery will not function in some cases (e.g. the e-mail address is wrong or there are technical problems). If you’ve forgotten your username or if you experience any other issues, you should&nbsp;</span></span></p>
                                            <ol>
                                                <li style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgba(64,64,64,0.4);">contact us through Live Support,&nbsp;</span></span></li>
                                                <li style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgba(64,64,64,0.4);">write us a letter using our support email address info@vbet.com &nbsp;</span></span></li>
                                                <li style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgba(64,64,64,0.4);">“Send a Message” option on My Profile page,&nbsp;</span></span></li>
                                                <li style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgba(64,64,64,0.4);">call us Tel.: +1-702-605-4859.</span></span></li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                <div class="module-container  align-left ModuleDivider
                                                 " style=" padding-right:40px;padding-left:30px;;   padding-bottom:1.9031141868512vh; ">
                                    <div class="  module ModuleDivider " datamodule-id="1783" style="display:block;max-width:60px;">
                                        <div class="divider-container">
                                            <div class="divider-inner" style="height: 2px; background: rgba(49, 49, 49, 0.27);"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="module-container   only-mobile   align-left ModuleParagraph
                                                 " style=" padding-right:30px;padding-left:30px;;   padding-bottom:1.982160555005vh; ">
                                    <div class="  module ModuleParagraph " datamodule-id="1784" style="display:block;max-width:1702px;">
                                        <div class="uc-content ">
                                            <h5 style="color:rgb(53, 53, 53);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);"><strong>How do I make a deposit in the online casino?</strong></span></span></h5>
                                            <p style="color:rgb(53, 53, 53);">&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">Once logged in, press the “Deposit” button on the top of your screen and select your desired amount and Payment method.</span></span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="module-container  align-left ModuleDivider
                                                 " style=" padding-right:40px;padding-left:30px;;   padding-bottom:1.982160555005vh; ">
                                    <div class="  module ModuleDivider " datamodule-id="1785" style="display:block;max-width:60px;">
                                        <div class="divider-container">
                                            <div class="divider-inner" style="height: 2px; background: rgba(49, 49, 49, 0.27);"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="module-container   only-mobile   align-left ModuleParagraph
                                                 " style=" padding-right:30px;padding-left:30px;;   padding-bottom:1.982160555005vh; ">
                                    <div class="  module ModuleParagraph " datamodule-id="1786" style="display:block;max-width:1702px;">
                                        <div class="uc-content ">
                                            <h5 style="color:rgb(53, 53, 53);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);"><strong>How do I view what games I’ve played last?</strong></span></span></h5>
                                            <p style="color:rgb(53, 53, 53);">&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">Once logged in, you can view a Last Played Games using the appropriate icons on the bottom of the Casino page.</span></span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="module-container  align-left ModuleDivider
                                                 " style=" padding-right:40px;padding-left:30px;;   padding-bottom:1.982160555005vh; ">
                                    <div class="  module ModuleDivider " datamodule-id="1787" style="display:block;max-width:60px;">
                                        <div class="divider-container">
                                            <div class="divider-inner" style="height: 2px; background: rgba(49, 49, 49, 0.27);"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="module-container   only-mobile   align-left ModuleParagraph
                                                 " style=" padding-right:30px;padding-left:30px;;   padding-bottom:1.982160555005vh; ">
                                    <div class="  module ModuleParagraph " datamodule-id="1788" style="display:block;max-width:1702px;">
                                        <div class="uc-content ">
                                            <h5 style="color:rgb(53, 53, 53);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);"><strong>What is the Random Number Generator (RNG)?</strong></span></span></h5>
                                            <p style="color:rgb(53, 53, 53);">&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">A Random Number Generator (RNG) is a computer program which randomly produces the results for our online casino games. Every individual card dealt, dice rolled, or any other pertinent game action is produced by the program without any unrealistic duplication or predictability.</span></span></p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">As the results are generated in a completely random manner without a possibility of manipulation, you always get fair results.</span></span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="module-container  align-left ModuleDivider
                                                 " style=" padding-right:40px;padding-left:30px;;   padding-bottom:1.982160555005vh; ">
                                    <div class="  module ModuleDivider " datamodule-id="1789" style="display:block;max-width:60px;">
                                        <div class="divider-container">
                                            <div class="divider-inner" style="height: 2px; background: rgba(49, 49, 49, 0.27);"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="module-container   only-mobile   align-left ModuleParagraph
                                                 " style=" padding-right:30px;padding-left:30px;;   padding-bottom:1.982160555005vh; ">
                                    <div class="  module ModuleParagraph " datamodule-id="1790" style="display:block;max-width:1702px;">
                                        <div class="uc-content ">
                                            <h5 style="color:rgb(53, 53, 53);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);"><strong>What kind of games can I play online at the Vbet Casino?</strong></span></span></h5>
                                            <p style="color:rgb(53, 53, 53);">&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">Vbet offers a wide selection of games to our players. You can find many different 3D games, Table games, a huge variety of Slot games, and even Live games including Blackjack, Roulette, Baccarat and Bet on Poker.</span></span></p>
                                            <p style="color:rgb(53, 53, 53);">&nbsp;</p>
                                            <h5 style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);"><strong>Do third party interface applications display full information about the customer’s gambles?</strong></span></span></h5>
                                            <p style="color:rgb(53, 53, 53);">&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">Please note that third party interface applications may not display full information about the customer's gambles.</span></span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="module-container  align-left ModuleDivider
                                                 " style=" padding-right:40px;padding-left:30px;;   padding-bottom:1.982160555005vh; ">
                                    <div class="  module ModuleDivider " datamodule-id="1791" style="display:block;max-width:60px;">
                                        <div class="divider-container">
                                            <div class="divider-inner" style="height: 2px; background: rgba(49, 49, 49, 0.27);"></div>
                                        </div>
                                    </div>
                          ...
                          last                         " style=" padding-right:30px;padding-left:30px;;  ">
                                    <div class="  module ModuleParagraph " datamodule-id="1792" style="display:block;max-width:1702px;">
                                        <div class="uc-content ">
                                            <h5 style="color:rgb(53, 53, 53);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);"><strong>General terms</strong></span></span></h5>
                                            <p style="color:rgba(49, 49, 49, 0.7);">&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">Our casino reserves the right to review transaction records and logs from time to time, for any reason whatsoever. If, upon such a review, it appears that player is participating in strategies that our casino in its sole discretion deems to be abusive, we reserve the right to revoke the entitlement of such a player to the promotion.</span></span></p>
                                            <p style="color:rgba(49, 49, 49, 0.7);">&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">We reserve the right to cancel any bonus or win which in our discretion is obtained by fraudulent use of the system. The accounts of such players will be immediately frozen.</span></span></p>
                                            <p>&nbsp;</p>
                                            <p style="color:rgba(49, 49, 49, 0.7);"><span style="font-family:Roboto;"><span style="color:rgb(64, 64, 64);">If the user places bets with a minimum chance of making profit and has a mere goal of increasing the number of bets at no chance of winning/losing, then it will be rendered as a dishonest game. In such cases the bonus, the profit won through the bonus and the money lost to the casino will be cancelled. An example of such a method is to bet simultaneously on the black and red fields of the roulette or to cover most of the table. However, this is not the only instance of applying this method. Any bet made with the least chance to win will be considered malicious.</span></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
