...
<div class="header-and-main-rows  " style="background: rgb(246, 246, 246); margin-bottom: -389.906px;">
    ...
    <div class="main-rows">
        <div class="uc-row-wrapper">
            <div class="uc-row first uc-animation staticParallax active" data-id="22064" data-effect="staticParallax" style="   margin-bottom:0vh;   background:rgba(248, 248, 248, 0); ">
                <div class="row-container ">
                    <div class="row mainRow " style="">
                        <div class="column col-sm-6 " datacolumn-id="34582" style="  padding:5.336179295624333vh 0vh;     ">
                            <div class="column-container vertical-center" style="">
                                <div class="module-container   only-mobile   align-center ModuleSpace
                         first                          " style="  padding-bottom:0vh; ">
                                    <div class="  module ModuleSpace " datamodule-id="96027">
                                        <div class="space-container">
                                            <div class="space-inner" style="height: 30px;">
                                            </div>
                                        </div>
                                        <style>
                                            .ModuleSpace[datamodule-id="96027"] .space-container {
                                                border-radius: 0 0 0 0;
                                            }

                                            .ModuleSpace[datamodule-id="96027"]:hover .space-container {
                                                border-radius: 0 0 0 0;
                                            }
                                        </style>
                                        <style>
                                            .ModuleSpace[datamodule-id="96027"] .uc-row .column:first-child {
                                                border-bottom-left-radius: 0;
                                                border-top-left-radius: 0;
                                            }

                                            .ModuleSpace[datamodule-id="96027"] .uc-row .column:last-child {
                                                border-bottom-right-radius: 0;
                                                border-top-right-radius: 0;
                                            }
                                        </style>
                          ...
                          last                         " style=" padding-right:80px;padding-left:40px;;  ">
                                    <div class="  module ModuleGallery " datamodule-id="96028" style="display:block;max-width:447px;">
                                        <style>
                                            #galleryPopup img {}
                                        </style>
                                        <script type="text/javascript">
                                            var pageLimit96028;
                                            var firstLoad96028 = false;
                                            var slider96028options = {
                                            ...
                                            var imgPerPage96028 = 3;
                                        </script>
                                        <input type="hidden" class="gallery-images-data" value="[{&quot;src&quot;:&quot;https:\/\/static.betconstruct.me\/fs\/userFiles\/vbetcom-updated\/images\/96028-cert-new.png&quot;,&quot;tags&quot;:[]}]">
                                        <div class="gallery   animated-96028" data-animated-id="96028" style="margin: -5px -5px;">
                                            ...
                                            <div data-width="100%" data-tags="[]" style="
                                                ...
                                                <div class=" gallery-img-container " style="padding-top:  133.33% ">
                                                    <div class="gallery-image" data-preview="1">
                                                        <div data-src="https://static.betconstruct.me/fs/userFiles/vbetcom-updated/images/96028-cert-new.png" data-webp="0" style="background-position: 50% 50%; background-image: url(&quot;https://static.betconstruct.me/fs/userFiles/vbetcom-updated/images/96028-cert-new.png&quot;);" data-bg="url('https://static.betconstruct.me/fs/userFiles/vbetcom-updated/images/96028-cert-new.png')" class="single-item lazy initial" data-was-processed="true">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="column col-sm-6 " datacolumn-id="34583" style="  padding:5.336179295624333vh 0vh;     ">
                            <div class="column-container vertical-center" style="">
                                <div class="module-container   only-mobile   align-left ModuleTitle
                         first                          " style=" padding-right:40px;padding-left:40px;;   padding-bottom:1.7382413087935vh; ">
                                    <div class="  module ModuleTitle " datamodule-id="96029">
                                        <div class="uc-content">
                                            <h1 class="font-14em"><span style="font-family:'Arm Hmks Bebas Neue Regular Custom';"><i><span style="color:rgb(255, 255, 255);">certificado RNG</span></i></span></h1>
                                        </div>
                                    </div>
                                </div>
                                <div class="module-container   only-mobile   align-left ModuleParagraph
                                    ...
                                    <div class="  module ModuleParagraph " datamodule-id="96030" style="display:block;max-width:460px;">
                                        <div class="uc-content ">
                                            <p class="font-11em" style="line-height:150%;"><span style="color:rgba(255, 255, 255, 0.7);">Alivecasino, el socio oficial de apuestas y juegos del Arsenal FC, es uno de los principales operadores de casinos en línea y de apuestas deportivas en todo el mundo, y ofrece a sus usuarios una variedad fascinante de juegos de casino en línea y en vivo, tragamonedas, póker y más.</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="module-container   only-mobile   align-left ModuleParagraph
                          last                         " style=" padding-right:40px;padding-left:40px;;  ">
                                    <div class="  module ModuleParagraph " datamodule-id="96031" style="display:block;max-width:460px;">
                                        <div class="uc-content ">
                                            <p><span style="color:rgba(255, 255, 255, 0.7);">Siempre nos hemos esforzado por ofrecer un servicio confiable que cumpla con todos los exigentes criterios actuales de la industria del juego. Estamos orgullosos de contar con el certificado NMN RNG, ya que NMi es una de las metodologías de prueba de RNG más sólidas y líderes del mercado en el sector de los juegos de azar en línea y físicos.</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bg-image lazy initial" data-bg="url('https://static.betconstruct.me/fs/userFiles/vbetcom-updated/images/r22064-back-15849551566015.jpg')" data-webp="0" style="opacity: 1; background-position: 0% 0%; background-image: url(&quot;https://static.betconstruct.me/fs/userFiles/vbetcom-updated/images/r22064-back-15849551566015.jpg&quot;);" data-was-processed="true">
                </div>
            </div>
        </div>
        <div class="uc-row-wrapper ">
            <div class="uc-row    last                           
                                                        ...
                                                        " data-id="22066" style="   margin-bottom:0vh;  ">
                <div class="row-container ">
                    <div class="row mainRow " style="">
                        <div class="column col-sm-12 " datacolumn-id="34586" style="      ">
                            <div class="column-container vertical-top" style="">
                                <div class="module-container  align-center ModuleCustomHtml
                         first   last                         ">
                                    <div class="  module ModuleCustomHtml " datamodule-id="96041">
                                        <div class="custom-html-container">
                                            <style>
                                                html .footer-rows .uc-row-wrapper:nth-child(1)>.uc-row>.row-container>.footerRow {
